...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Data Menu Apps</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
              ...
              <table cellspacing="10" width="100%" class="table table-bordered" roles="cols">
                  ...
                  @foreach($listMenu as $data)
                      <tr>
                          ...
                          <form name="myform" id="myform" style="display: inline;" action="{{route('menu.destroy', $data->id)}}" method="post" onsubmit="return confirm('Are you sure you want to delete {{$data->name}}');">
                                            {{ method_field('DELETE') }}
                                            @csrf
                                            <button type="submit">
                                                <i class="fa fa-trash red"></i>
              ...
              <form method="POST" action="{{ route('menu.store') }}" role="form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Nama Menu Apps" name="name">
                  </div>
                  <div class="form-group">
